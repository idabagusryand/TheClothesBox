<!-- GANTI NAMA FILE admin JADI ADMIN -->
        ...
        <div class="row no-gutters">
          ...
          <div class="col-md-7">
            <div class="card-body">
              ...
              <p class="login-card-description">Sign In as Admin</p>
              <form method="post">
                  <div class="form-group">
                    <label for="email" class="sr-only">Email</label>
                    <input type="email" name="admin_email" id="admin_email" class="form-control" placeholder="Email address" minlength="3" required>
                  </div>
                  <div class="form-group mb-4">
                    <label for="password" class="sr-only">Password</label>
                    <input type="password" name="admin_password" id="admin_password" class="form-control" placeholder="Password" minlength="5" required>
                  </div>
