...
include("../config.php");
error_reporting(0);
$account = $_SESSION["distributor_email"];
...
if (isset($_POST['save'])) {
  ...
  $query = mysqli_query($con, "UPDATE distributor SET Name = '$name', PhoneNum = '$phonenum', Email = '$email' WHERE Email = '$account'");

  if ($query) {
    echo "<script>alert('Profile Successfully Updated');</script>";
    echo "<script type='text/javascript'> document.location ='distributor_profile.php'; </script>";
  } else {
      ...
      <div class="hero-title">
        <div class="bg-white p-3 border rounded" style="width: 450px;">
          <form method="POST" action="">
            <?php
            $ret = mysqli_query($con, "SELECT * FROM distributor WHERE Email = '$account'");
            $cnt = 1;
            ...
            ?>
                <table style="border: none;">
                  ...
                  <tr>
                    ...
                    <td style="border: none;">: </td>
                    <td style="border: none;"><input class="form-control" type="email" name="Email" value="<?php echo $row['Email']; ?>" required></td>
                  <tr>
                </table>
