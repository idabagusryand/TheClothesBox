...
$s = "select * from donatur where email = '$email'";
...
if (isset($_POST["login"])) {
  ...
  if ($num == 1) {
    ...
    if($password === $confirm_pass){
      $reg = "insert into donatur (name, phonenum, email, password) values ('$name', '$phonenum', '$email', MD5('$password'))";
    ...
    <div class="container">
      <div class="card login-card">
        <div class="row no-gutters">
          <div class="col-md-5">
            <img src="../img/logo.jpeg" alt="login" class="login-card-img-2">
          </div>
          <div class="col-md-7">
            <div class="card-body">
              
              <p class="login-card-description">Sign Up as donatur</p>
              <form method="post">
                ...
                <p class="login-card-footer-text">Already have an account? <a href="donatur_signin.php" class="text-reset">Login here</a></p>
