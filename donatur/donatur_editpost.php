...
if (isset($_POST['upload'])) {
    ...
    if (!in_array($extension, $allowed_extensions)) {
        ...
        $query = mysqli_query($con, "update donasi SET picture = '$imgnewfile', donasi = '$donasi', description = '$description', name = '$name', email = '$email' where id = '$ID'");
        if ($query) {
            echo "<script>alert('You have successfully post the donasi');</script>";
            echo "<script type='text/javascript'> document.location ='../distributor/distributor_upload.php'; </script>";
        } else {
...
$ID = $_GET['id'];
$ret = mysqli_query($con, "select * from donasi where id = '$ID'");
$cnt = 1;
...
?>
        ...
        <body>
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <input type="text" name="donasi" value="<?php echo $row['donasi']; ?>" required="true"><br>
